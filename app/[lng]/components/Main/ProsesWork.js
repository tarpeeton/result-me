...
const ProsesWork = () => {
  ...
  return (
    <div className='flex flex-col mt-[80px] gap-[10px]'>
      ...
      <div className='hidden mdl:block w-full'>
        <Slider {...settings} className='w-full'>
          {/* CARD 1 */}
          <div className='w-full mdl:max-w-full  4xl:max-w-[50%] rounded-[30px] bg-violet100 p-[30px] pb-[26px] flex flex-col justify-between'>
            ...
            <div className='py-[20px] px-[30px] rounded-[100px] bg-white text-center mt-[51px] mdl:w-[300px] 4xl:ml-[55%]'>
              <Link href='free' className='text-[14px] font-bold text-violet100 mdl:text-[18px]'>
                Бесплатная консультация
              </Link>
            </div>
          </div>
          {/* CARD 2 */}
          <div className='w-full mdl:min-w-full  4xl:max-w-[50%] rounded-[30px] bg-[#F4F3FF] p-[30px] pb-[26px] flex flex-col justify-between'>
            <div className='w-[60%]'>
              <p className='text-[23px] mdl:text-[40px] text-titleDark font-bold 4xl:text-[50px]'>РАБОТАЕМ ПО ДОГОВОРУ</p>
            </div>
          ...
          {/* CARD 3 */}
          <div className='w-full  mdl:min-w-full  rounded-[30px] bg-[#F4F3FF] p-[30px] pb-[26px] flex flex-col justify-between'>
            <div className='w-[60%]'>
              <p className='text-[23px] mdl:text-[40px] text-titleDark font-bold 4xl:text-[50px]'>УТВЕРЖДАЕМ ПЛАНЫ</p>
            </div>
            <div className='mt-[15px] w-[85%] mdl:mt-[40px]'>
              <p className='text-[14px] mdl:text-[18px] text-[#454545]'>
      ...
      <div className="sm:flex sm:flex-col sm:gap-[20px] mdl:hidden">
