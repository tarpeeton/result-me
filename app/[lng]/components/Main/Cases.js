...
const Cases = () => {
	...
	return (
		<div className='mt-[80px] mdl:mt-[100px] 2xl:mt-[200px]'>
			...
			<div className='mt-[40px] mdx:mt-[60px] w-[175px] h-[50px] px-[30px] py-[20px] mx-auto rounded-[100px] bg-violet100 flex items-center justify-center xl:mt-[60px] 3xl:mt-[100px] 4xl:w-[300px] 4xl:h-[62px] 4xl:mt-[60px]'>
