...
const AboutUs = () => {
	return (
		<div className='rounded-[30px] bg-violet100 mdl:rounded-[60px] 2xl:rounded-[100px] px-[20px] py-[30px] w-full mt-[20px] mdl:mt-[25px] 2xl:mt-[30px] mdl:px-[40px] 2xl:px-[70px] mdl:py-[50px] 2xl:py-[80px]  relative mdl:overflow-hidden'>
