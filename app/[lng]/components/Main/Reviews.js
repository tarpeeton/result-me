...
const handleNext = () => {
  ...
  return (
    <div
      className="relative w-full mt-[20px] mdl:mt-[30px] rounded-[30px] bg-cover bg-no-repeat px-5 py-8"
    ...
    >
      ...
      <Slider {...settings} ref={sliderRef} className='z-[99999]'>
        <div className="rounded-xl p-4 bg-[#161616] bg-opacity-[50%]  text-white shadow-md">
          <h3 className="text-[18px] font-bold mb-2">Матьякуб Назарович</h3>
      ...
      <div className="text-center mt-6 flex items-center z-[99999]">
		...
		<div className='sm:hidden flex flex-row gap-[8px] 2xl:flex'>
