...
import KontektReklama from "./assets/result-site-quiz-step-4-photo-1.png";
import targetReklama from "./assets/result-site-quiz-step-4-photo-2.png";
...
const initialCalcData = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        title: {
          ru: "Конверсия в клиента",
          uz: "Xaridorga konversiya",
          en: "Conversion to Clients",
        },
        saleSymbol: "%",
        from: 3,
        to: 100,
        ...
        active: false,
        descriptions: {
          ru: "Процент встреч, приводящих к заключению сделки с клиентом",
          uz: "Mijoz bilan kelishuvga olib keladigan uchrashuvlar foizi ",
          en: "The percentage of appointments that result in a client deal",
        },
      },
    ],
  },
...
export default function CalculatorMain() {
  ...
  const handleSelection = (item) => {
    const selectedData = calcData.find(
        ...
        <div className="space-y-4">
          ...
          <p className="text-[#7B7B7B] w-full max-w-[900px]">
            {lng === "ru"
              ...
              : lng === "uz"
              ? "Reklama kampaniyangiz bilan jalb qilingan mijozlar sonini aniq hisoblash uchun kalkulyatordan foydalaning..."
              : "Use the calculator to accurately calculate the number of customers attracted through your advertising campaign..."}
          </p>
        </div>
        <div className="space-y-4 mt-12">
          <h2 className="text-3xl max-mdl:text-xl font-semibold">
            {lng === "ru"
              ...
              : lng === "uz"
              ? "Reklama usulini tanlang:"
              : "Choose the promotion method:"}
          </h2>
          <div className="grid grid-cols-1 mdl:grid-cols-2 gap-4">
            {data.map((item, index) => (
              <ButtonCard
                ...
                item={item}
                selectedItems={
                  selectedCalculator ? [selectedCalculator.title] : []
                }
              />
            ))}
          </div>
          ...
          <div className="mt-24">
            ...
            <div className="w-full flex items-center justify-center">
              <button
                ...
                className="px-12 py-3 mt-8 rounded-full bg-[#7B72EB] text-white font-semibold"
              >
                {lng === "ru"
                  ? "Рассчитать"
                  : lng === "uz"
          ...
          <div className="mt-12 w-full flex items-center flex-col justify-center">
            ...
            <div className="flex gap-4 max-mdl:flex-col">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-2xl text-[#7B72EB]">
