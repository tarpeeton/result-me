...
const data = [
		...
		providedService: [
			{
				title: 'Разработка сайта',
				descriptions: [
					'Мы создали современный и функциональный сайт, полностью соответствующий требованиям клиента.',
				],
			},
			{
				title: 'Брендинг',
				descriptions: [
					'Разработали логотип, визитки и другие маркетинговые материалы для формирования сильного имиджа компании.',
				],
			},
			{
				title: 'Запуск контекстной рекламы',
				descriptions: [
					'Настроили таргетированную рекламу, направленную на соответствующие рынки, для привлечения новых клиентов.',
				],
			},
		],
	},
	...
	},
	{
		...
		providedService: [
			...
			{
				title: 'Разработка сайта',
				descriptions: ['Создан современный и информативный сайт для клиники.'],
			},
			{
				title: 'Запуск контекстной рекламы',
				descriptions: [
	...
	},
	{
		...
		providedService: [
			{
				title:
					'Создали современный и интуитивно понятный сайт, который соответствует всем актуальным требованиям. В процессе работы были внедрены новые функции, такие как:',
				descriptions: [
