				...
				<div>
					...
					<div className='mt-[12px] mdl:mt-[30px]'>
						<p className='text-[14px] mdl:text-[18px] mdl:font-semibold font-medium text-white100 font-robotoFlex'>
							Агентство, специализирующееся на комплексном продвижении
							медицинских учреждений и специалистов. Наша миссия — помогать
							медицинскому бизнесу расти, используя современные маркетинговые
							стратегии и IT-решения
						</p>
					</div>
				</div>
