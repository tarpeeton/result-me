...
const data = [
	{
	  ...
	  shortDescription: 'Разработка сайтов, которые просты в использовании и выглядят профессионально, помогая бизнесу выделяться в интернете...',
	  icon: web,
	  active: true,
	  main: true,
	},
	{
	  ...
	  shortDescription: 'Создание Telegram-ботов, которые облегчают общение с клиентами и автоматизируют рутинные процессы...',
	  icon: bot,
	  active: true,
	  main: true,
	},
	{
	  ...
	  slug: 'smm',
	  name: 'SMM',
	  shortDescription: 'Помощь в создании и управлении социальными сетями, чтобы увеличить аудиторию и улучшить имидж бренда...',
	  icon: smm,
	  active: true,
	  main: true,
	},
	{
	  ...
	  slug: 'ads-launch',
	  name: 'Запуск рекламы',
	  shortDescription: 'Настройка рекламы, которая привлекает нужных клиентов и приносит бизнесу больше прибыли...',
	  icon: Group,
	  active: true,
	  main: true,
	},
	{
	  ...
	  slug: 'seo',
	  name: 'SEO',
	  shortDescription: 'Оптимизация сайта, чтобы он был выше в поисковых системах и привлекал больше посетителей...',
	  icon: seo,
	  active: true,
	  main: true,
	},
	{
	  ...
	  slug: 'branding',
	  name: 'Брендинг',
	  shortDescription: 'Создание уникального стиля и образа для бизнеса, который будет легко узнаваем и привлекателен для клиентов...',
	  icon: branding,
	  active: true,
	  main: true,
	},
