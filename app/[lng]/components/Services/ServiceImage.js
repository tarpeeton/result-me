	...
	return (
		<div className='mt-[20px] mdl:mt-[20px] 3xl:mt-[25px] rounded-[30px] mdl:rounded-[40px] flex flex-col 3xl:flex-row py-[30px] px-[24px] mdl:py-[50px] mdl:px-[40px] 3xl:py-[80px] 3xl:px-[70px] bg-white mx-[16px] mdl:mx-[20px] 3xl:mx-[30px]'>
			{filteredData.map((data, i) => (
				<div key={i} className={`${i !== serviceImageData.length - 1 ? 'mb-[50px] mdl:mb-[80px]' : ''} flex flex-col mdl:flex-row mdl:justify-between 2xl:w-[50%] 2xl:flex-col 2xl:justify-normal`}>
					<Image
						src={data.img}
						quality={100}
						width={300}
					...
					<h1 
				className={`text-titleDark font-bold  2xl:min-h-[120px] text-[23px] mdl:text-[40px] mt-[15px] ${i === 1 ? 'mdl:w-[50%]' : ''}`}
			>
