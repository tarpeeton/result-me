...
const data = [
  {
    ...
    statistics: [
      { value: "+17%", label: "Конверсия с сайта за 1 месяц" },
      { value: "200+ лидов", label: "По цене 2,1$ за лид в течение 1 месяца" },
      { value: "+15%", label: "Увеличение числа подписчиков" },
    ],
  },
  {
    id: 2,
    ...
    statistics: [
      ...
      // { value: "Фирменный стиль", label: "Логотип, раздаточный материал" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    statistics: [
      ...
      { value: "Имидж врача", label: "Укрепление личного бренда врача" },
    ],
  },
  {
    id: 5,
    ...
    statistics: [
      {label: 'Контент-менеджмент для SMM'}
    ],
  },
  {
    id: 6,
    ...
    statistics: [
      { value: "+4,820", label: "кликов на сайт / за 1 месяц" },
      { value: "0,10$", label: "цена за клик / за 1 месяц" },
      { value: "+14,22%", label: "CTR / за 1 месяц" },
    ],
  },
  {
    id: 7,
    ...
    statistics: [
      { value: "2,450", label: "кликов на сайт / за 1 месяц" },
      { value: "0,05$", label: "цена за клик / за 1 месяц" },
      { value: "11,64%", label: "CTR / за 1 месяц" },
    ],
  },
  {
    id: 8,
    ...
    statistics: [
      {label: "Увеличение числа клиентов через сайт"},
      {label: "Улучшение пользовательского опыта"},
    ],
  },
  {
    id: 10,
    ...
    statistics: [
      { label: "Профессиональный имидж" },
      { label: "Увеличение доверия" },
    ],
  },
  {
    id: 11,
    ...
    statistics: [
      { value: 'SMM' ,
        label: 'Instagram / Telegram / YouTube'}
    ],
  },
  {
    id: 12,
    ...
    statistics: [
      { value: "2,840", label: "кликов на сайт   / за 1 месяц" },
      { value: "0,11$", label: "цена за клик   / за 1 месяц" },
      { value: "13,63%", label: "CTR   / за 1 месяц" },
    ],
  },
  {
    id: 13,
    ...
    statistics: [
      { value: '14,500', label: 'кликов на сайт' },
