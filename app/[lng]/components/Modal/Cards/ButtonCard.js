...
export default function ButtonCard({ title, descriptions, icon }) {
  return (
    <div className="bg-white group hover:scale-[1.03] transition-all duration-300 relative rounded-2xl cursor-pointer p-4 hover space-y-4 flex flex-col justify-between h-auto min-h-[300px]">
